...
This repository is LCDS robotics group code forked from FTC SDK for the Freight Frenzy (2021-2022) competition season.

## Welcome!
This repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/CountryDayTSA/FtcRobotController.git</p>
